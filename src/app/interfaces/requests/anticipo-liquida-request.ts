export interface LiquidarAnticipoRequest {
  num_liquidacion: number;
  fecha_liquidacion?: string | null; // DateOnly como string ISO 'YYYY-MM-DD'
  id_anticipo: number;
  ...
  fecha_ingreso?: string | null; // DateOnly como string ISO 'YYYY-MM-DD'
