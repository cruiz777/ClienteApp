  ...
  refrescar(): void {
    ...
    if (this.modoFiltro === 'cuenta') {
      ...
      // Caso B: Rango completo de cuentas => VALIDAR y PERMITIR
        ...
        if (hasta < desde) {
          this.message.error('La Cuenta Final no puede ser menor a la Cuenta Inicial');
      ...
      // Caso D: No hay cuentas ni tipo => ERROR
        ...
        this.message.error('Debe seleccionar Tipo de Asiento o ingresar un rango de cuentas.');
