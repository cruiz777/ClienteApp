...
export class ReporteComprasComponent implements OnInit {
  ...
  ngOnInit(): void {
    ...
    this.comprasColumnDefs = [
        ...
        { headerName: 'Cód. IVA 10% B',     field: 'codIvaBienes10', width: 110, cellStyle: { textAlign: 'center' }, headerClass: 'header-retenciones-iva' },
        ...
        { headerName: 'Cód. IVA 20% B',     field: 'codIvaBienes20', width: 110, cellStyle: { textAlign: 'center' }, headerClass: 'header-retenciones-iva' },
        ...
        { headerName: 'Cód. IVA 30% B',     field: 'codIvaBienes30', width: 110, cellStyle: { textAlign: 'center' }, headerClass: 'header-retenciones-iva' },
        ...
        { headerName: 'Cód. IVA 50% S',     field: 'codIvaServ50',   width: 110, cellStyle: { textAlign: 'center' }, headerClass: 'header-retenciones-iva' },
        ...
        { headerName: 'Cód. IVA 70% S',     field: 'codIvaServ70',   width: 110, cellStyle: { textAlign: 'center' }, headerClass: 'header-retenciones-iva' },
