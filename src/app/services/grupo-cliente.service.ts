...
export class GrupoClienteService {
  ...
  create(data: GrupoClienteRequest): Observable<GrupoClienteResponse> {
    return this.http.post<GrupoClienteResponse>(this.apiUrl, data);
  }

  update(id: number, data: GrupoClienteRequest): Observable<GrupoClienteResponse> {
    return this.http.put<GrupoClienteResponse>(`${this.apiUrl}/${id}`, data);
  }
